...
DEFAULT_UOM_MAPPINGS = (
    ...
    ('uom.product_uom_square_foot', 'orchida_ksa_e_invoicing_trial.orchida_unit_code_ftk'),
    ...
    ('uom.product_uom_square_meter', 'orchida_ksa_e_invoicing_trial.orchida_unit_code_mtk'),
