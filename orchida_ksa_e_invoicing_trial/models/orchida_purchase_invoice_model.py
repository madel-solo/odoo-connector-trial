# models/orchida_purchase_invoice.py
...
class OrchidaPurchaseInvoice(models.Model):
    ...
    def action_view_pdf(self):
        return self.env.ref(
            'orchida_ksa_e_invoicing_trial.report_orchida_invoice_pdf'
        ).report_action(self)
    ...
    def action_view_ubl_pdf(self):
        return self.env.ref(
            'orchida_ksa_e_invoicing_trial.report_orchida_invoice_ubl_pdf'
        ).report_action(self)
